...
{
	{ "Annie", "infernalguardian", isSkillshotCircle, kSlotR, false, "", 0.f },
	{ "Amumu", "curseofthesadmummy", isSelfCast, kSlotR, false, "", 550.f },
	{ "Ashe", "enchantedcrystalarrow", isSkillshotLine, kSlotR, true, "enchantedcrystalarrow", 0.f },
	{ "AurelionSol", "aurelionsolr", isSkillshotLine, kSlotR, true, "notyet", 0.f },
	{ "Azir", "azirr", isSkillshotCircle, kSlotR, false, "", 0.f },
	{ "Braum", "braumrwrapper", isSkillshotLine, kSlotR, true, "braumrmissile", 0.f},
	{ "Blitzcrank", "rocketgrab", isSkillshotLine, kSlotQ, true, "rocketgrabmissile", 0.f},
	{ "Caitlyn", "caitlynaceintheholemissile", isTargeted, kSlotR, true, "caitlynaceintheholemissile", 0.f},
	{ "Cassiopeia", "cassiopeiar", isSkillshotCircle, kSlotR, false, "", 0.f },
	{ "Chogath", "feast", isTargeted, kSlotR, false, "", 0.f },
	{ "Darius", "dariusexecute", isTargeted, kSlotR, false, "", 0.f },
	{ "Draven", "dravenr", isSkillshotLine, kSlotR, true, "dravenr", 0.f },
	{ "Evelynn", "evelynnr", isSkillshotCircle, kSlotR, false, "", 0.f },
	{ "Ezreal", "ezrealtrueshotbarrage", isSkillshotLine, kSlotR, true, "ezrealtrueshotbarrage", 0.f },
	{ "Fizz", "fizzr", isSkillshotLine, kSlotR, true, "fizzrmissile", 0.f },
	{ "Gnar", "gnarult", isSelfCast, kSlotR, false, "", 0.f },
	{ "Garen", "egarenr", isTargeted, kSlotR, false, "", 0.f },
	{ "Gragas", "gragasr", isSkillshotCircle, kSlotR, true, "gragasrboom", 0.f},
	{ "Graves", "graveschargeshot", isSkillshotLine, kSlotR, true, "graveschargeshot", 0.f },
	{ "Hecarim", "hecarimult", isSkillshotLine, kSlotR, true, "hecarimultmissile", 0.f },
	{ "Illaoi", "illaoir", isSelfCast, kSlotR, false, "", 0.f },
	{ "JarvanIV", "jarvanivcataclysm", isTargeted, kSlotR, false, "", 0.f },
	{ "Jinx", "jinxr", isSkillshotLine, kSlotR, true, "jinxr", 0.f },
	{ "LeeSin", "blindmonkrkick", isTargeted, kSlotR, false, "", 0.f },
	{ "Leona", "leonasolarflare", others, kSlotR, false, "", 250.f},
	{ "Lissandra", "lissandrar", isTargeted, kSlotR, false, "", 0.f },
	{ "Lux", "luxmalicecannon", isSkillshotLine, kSlotR, true, "luxrvfxmis", 0.f },
	...
	{ "Shyvana", "shyvanatrasformcast", isSkillshotLine, kSlotR, false, "", 0.f },
...
std::map<std::string, IMenuOption*> SpellsHP;
